...
const GoalsHabits = () => {
  ...
  const [goalImageFile, setGoalImageFile] =
    useState<File | null>(null);
  const [habitImageFile, setHabitImageFile] =
    useState<File | null>(null);
  ...
  const loadReminderPreferences = () => {
    if (typeof window === "undefined") return;
    const savedTime =
      localStorage.getItem("habitReminderTime");
  ...
  const fetchData = async () => {
    try {
      ...
      const [goalsRes, habitsRes, logsRes] =
        await Promise.all([
          supabase
            .from("goals")
            .select("*")
      ...
      toast({
        title: "Error",
        description:
          "Failed to load goals and habits",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const createGoal = async () => {
    try {
      ...
      toast({
        title: "Goal Created",
        description:
          "Your goal has been added to the board.",
      });
    ...
    try {
      if (!newHabit.name.trim()) {
        toast({
          title: "Missing name",
          description:
            "Please enter a habit name before saving.",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        title: "Habit Created",
        description:
          "Your habit has been added to today's list.",
      });
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Visualize and track your goals and daily
            habits.
          </p>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-semibold text-blue-50">
                  {goalStats.completionRate.toFixed(
                    0
                  )}
                  %
                </p>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Get daily reminders to track your
                habits.
              </p>
            </div>
            <Button
          ...
          {goals.length === 0 ? (
            <Card className="border-border bg-card md:col-span-2 lg:col-span-3">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  No goals yet. Create your first
                  goal to get started!
                </p>
              </CardContent>
            </Card>
