...
const StatCard = ({
  ...
  return (
    <Card className="relative overflow-hidden border-white/10 bg-[#12131a]/80 backdrop-blur-xl">
      <div
        className={cn(
      ...
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <DialogTrigger asChild>
                <Button className="gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-lg shadow-emerald-500/25">
                  <Plus className="h-4 w-4" />
                  New Playbook
                </Button>
              </DialogTrigger>
              <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto bg-[#12131a] border-white/10">
                <DialogHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Label htmlFor="image-upload" className="cursor-pointer">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors">
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          className="w-48 bg-white/5 border-white/10 text-white placeholder:text-gray-500"
                        />
                        <Button
                    ...
                    {firstGroup && (
                      <Tabs defaultValue={firstGroup} className="w-full">
                        <TabsList className="w-full flex-wrap h-auto bg-white/5 border border-white/10">
        ...
        {viewMode === "gallery" && (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {isLoading ? (
              <Card className="border-white/10 bg-[#12131a]/80 col-span-full">
              ...
              <Card className="border-white/10 bg-[#12131a]/80 col-span-full">
                <CardContent className="pt-6">
                  <div className="text-center py-12">
                    ...
                    <p className="text-lg mb-2 text-gray-300">No playbooks yet</p>
                    <p className="text-sm text-gray-500">
              ...
              strategies.map((strategy) => (
                <Card
                  key={strategy.id}
                  className="border-white/10 bg-[#12131a]/80 hover:border-emerald-500/50 transition-all cursor-pointer group overflow-hidden"
        ...
        {/* Table View */}
        {viewMode === "table" && (
          <Card className="border-white/10 bg-[#12131a]/80 overflow-hidden">
            <Table>
              <TableHeader>
        ...
        {viewMode === "calendar" && (
          <div className="grid lg:grid-cols-[320px_1fr] gap-6">
            <Card className="border-white/10 bg-[#12131a]/80 p-4 h-fit">
              <Calendar
                mode="single"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                getStrategiesForDate(selectedDate).length === 0 ? (
                  ...
                  getStrategiesForDate(selectedDate).map((strategy) => (
                    <Card
                      key={strategy.id}
                      className="border-white/10 bg-[#12131a]/80 hover:border-emerald-500/50 transition-all cursor-pointer overflow-hidden"
                      onClick={() => openEditDialog(strategy)}
                    >
                      {strategy.image_url && (
