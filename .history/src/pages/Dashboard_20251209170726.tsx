...
// Traders Level Component
const TradersLevelChart = memo(
  ({
    stats,
  }: {
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className={cn("text-xs sm:text-sm font-bold", currentLevel.color)}>
        ...
        <div className="flex items-center justify-between">
          <span className={cn("text-[9px] sm:text-[11px] font-medium", currentLevel.color)}>
            {currentLevel.name}
          </span>
          {nextLevel ? (
