...
// -------------------------------------------------------------------------------------
// Performance summary block (updated All‑Time card)
// -------------------------------------------------------------------------------------
...
const PerformanceSummary = memo(function PerformanceSummary({
  ...
  // Special, richer card for All‑Time
  if (isAllTime) {
    return (
      <Card className="analytics-glass analytics-card-hover relative overflow-hidden">
        ...
        <CardHeader className="relative z-10 pb-3">
          ...
          <CardDescription className="text-gray-400">
            Lifetime snapshot of your trading results
          </CardDescription>
        </CardHeader>

        <CardContent className="relative z-10 pt-3 space-y-6">
          {/* Top row: big lifetime P&L + chips */}
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2 text-[11px] sm:text-xs">
              <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-200">
                {metrics.totalTrades} trades
              </div>
              <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-emerald-300">
                {metrics.winRate.toFixed(1)}% win rate
              </div>
              <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-200">
                {metrics.netDailyPnL >= 0 ? "+" : ""}
                {formatCurrency(metrics.netDailyPnL)} / day
              </div>
            </div>
          </div>

          {/* Middle row: key efficiency metrics */}
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3 rounded-xl bg-black/25 border border-white/10">
              ...
              <p className="text-xl font-semibold text-white">
                {formatMinutes(metrics.avgTradeTime)}
              </p>
              <p className="text-[11px] text-gray-500 mt-1">
          ...
          <div className="pt-4 border-t border-white/10">
            <p className="text-xs text-gray-400 mb-3">
              Lifetime Trade Distribution
            </p>
            <div className="flex gap-2">
              <div
                className="bg-emerald-500/20 border border-emerald-500/30 h-10 rounded-lg flex-1 flex items-center justify-center text-xs font-medium text-emerald-300 hover:bg-emerald-500/25 transition-colors"
                style={{
                  flexGrow:
              ...
              <div
                className="bg-red-500/20 border border-red-500/30 h-10 rounded-lg flex-1 flex items-center justify-center text-xs font-medium text-red-300 hover:bg-red-500/25 transition-colors"
                style={{
                  flexGrow:
