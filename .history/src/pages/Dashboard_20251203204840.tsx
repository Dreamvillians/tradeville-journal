...
// Dashboard Styles
// Removed the .dash-ticker styles as they are now global
  ...
  ({
    ...
    return (
      ...
      >
        ...
        <CardContent
          className={cn("relative z-10", size === "large" ? "p-6" : "p-4")}
        >
...
// Quick Actions (overlay fixed, card prepared to sit next to Welcome card)
const QuickActions = memo(({ onNavigate }: { onNavigate: (path: string) => void }) => {
  ...
  return (
    <Card className="dash-glass dash-card-hover relative overflow-hidden h-full">
      {/* Overlay behind content and non-interactive */}
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0b0f] text-white relative overflow-x-hidden">
      ...
      <div
        className={cn(
          "relative z-10 pt-6 pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto transition-all duration-700",
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2 dash-slide-up" style={{ animationDelay: "100ms" }}>
            <StatCard
              title="Total P&L"
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2 dash-slide-up" style={{ animationDelay: "150ms" }}>
            <StatCard
              title="Win Rate"
          ...
          <div
            className="col-span-1 md:col-span-2 lg:col-span-4 dash-slide-up"
          ...
          {/* Row 5: Goals & Metrics - Dedicated Row */}
          <div className="col-span-1 md:col-span-1 lg:col-span-2 dash-slide-up" style={{ animationDelay: "500ms" }}>
            <TradingGoals stats={stats} />
          </div>

          <div className="col-span-1 md:col-span-1 lg:col-span-2 dash-slide-up" style={{ animationDelay: "550ms" }}>
