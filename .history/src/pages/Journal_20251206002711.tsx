...
const JOURNAL_STYLES = `
  ...
  .custom-scrollbar::-webkit-scrollbar-track {
    background: rgba(255, 255, 255, 0.05); /* Very faint white track */
    border-radius: 8px;
  }
  .custom-scrollbar::-webkit-scrollbar-thumb {
    background: rgba(255, 255, 255, 0.3); /* Visible white thumb */
    border-radius: 8px;
    border: 3px solid transparent; /* Creates padding around thumb */
    background-clip: content-box;
  }
  .custom-scrollbar::-webkit-scrollbar-thumb:hover {
    background: rgba(255, 255, 255, 0.6); /* Brighter white on hover */
...
const Journal = () => {
  ...
  return (
    <div className="flex-1 w-full min-w-0 h-screen bg-[#0a0b0f] text-white relative font-sans selection:bg-emerald-500/30 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 min-h-0 w-full relative z-10 px-3 sm:px-6 lg:px-8 pb-4 sm:pb-6">
        
        {/* Trade Form Overlay */}
        {showForm && (
          <div className="absolute inset-0 z-50 bg-black/80 p-4 backdrop-blur-sm animate-in fade-in flex items-center justify-center">
