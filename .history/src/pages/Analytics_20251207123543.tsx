...
// -------------------------------------------------------------------------------------
// Equity curve chart – Gradient Area, type="monotone"
// -------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------
// PnL by Strategy / Symbol / Weekday – Bar charts
// -------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------
// Risk vs Reward scatter – R-multiple vs P&L
// -------------------------------------------------------------------------------------
...
const RiskRewardScatterChart = memo(function RiskRewardScatterChart({
  ...
  const data = useMemo(() => {
    ...
    return trades.map((t) => {
      const pnl = t.profit_loss_currency || 0;
      return {
        rMultiple: pnl / basis, // approximate R multiple
        pnl,
        symbol: t.symbol,
        side: t.side,
      };
...
// -------------------------------------------------------------------------------------
// Strategy performance list (kept as-is, textual ranking)
// -------------------------------------------------------------------------------------
