...
const AnimatedCandlesticks = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 h-48 flex items-end justify-center gap-3 opacity-20 overflow-hidden">
      {candles.map((candle) => (
        <div
          key={candle.id}
          className="relative flex flex-col items-center animate-candlestick"
        ...
        >
          ...
          <div 
            className={cn(
              "w-3 rounded-sm transition-all duration-1000",
...
const AnimatedTicker = () => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 overflow-hidden bg-black/30 backdrop-blur-sm border-b border-white/5">
...
const FloatingOrbs = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Large gradient orbs */}
    <div className="absolute -top-40 -left-40 w-80 h-80 bg-emerald-500/30 rounded-full blur-[100px] animate-float-slow" />
    <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-blue-500/20 rounded-full blur-[120px] animate-float-slow-reverse" />
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-500/10 rounded-full blur-[150px] animate-pulse-slow" />
    ...
    {[...Array(30)].map((_, i) => (
      <div
        ...
        style={{
          ...
          top: `${Math.random() * 100}%`,
          background: `rgba(${Math.random() > 0.5 ? '16, 185, 129' : '59, 130, 246'}, ${0.2 + Math.random() * 0.3})`,
...
const AnimatedGrid = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Grid */}
    <div className="absolute inset-0 bg-[linear-gradient(to_right,#10b98110_1px,transparent_1px),linear-gradient(to_bottom,#10b98110_1px,transparent_1px)] bg-[size:50px_50px] animate-grid-flow" />
    
    {/* Scanning line */}
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute w-full h-[2px] bg-gradient-to-r from-transparent via-emerald-500/50 to-transparent animate-scan-line" />
    </div>
  </div>
);
...
const AnimatedLogo = ({ size = "default" }: { size?: "default" | "large" }) => {
  ...
  return (
    <div className="relative group">
      {/* Glow effect */}
      <div className={cn(
        "absolute inset-0 rounded-xl bg-gradient-to-br from-emerald-500 to-blue-500 blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500 animate-pulse-glow",
        sizeClasses
      )} />
      ...
      <div className={cn(
        sizeClasses,
        "relative rounded-xl bg-gradient-to-br from-emerald-500 via-emerald-600 to-blue-600 flex items-center justify-center shadow-2xl shadow-emerald-500/25 animate-logo-float"
      )}>
        {/* Inner glow */}
...
const FeatureCard = ({ icon: Icon, title, description, index }: { 
  ...
  <div 
    className="flex items-start gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 transform transition-all duration-500 hover:scale-[1.02] hover:bg-white/10 hover:border-emerald-500/30 group animate-slide-up opacity-0"
...
const SocialButton = ({ 
  ...
  <div className="relative w-full group">
    {isLastUsed && (
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20 animate-bounce-gentle">
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-[#0a0b0f] text-white selection:bg-emerald-500/30">
      ...
      <style>{`
        ...
        .animate-scan-line { animation: scan-line 8s ease-in-out infinite; }
        .animate-ticker { animation: ticker 30s linear infinite; }
        .animate-candlestick { animation: candlestick 3s ease-in-out infinite; }
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center p-12 relative z-10 border-r border-white/5">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-4 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <AnimatedStat value="50K+" label="Active Traders" suffix="K+" />
            <AnimatedStat value="2M+" label="Trades Logged" suffix="M+" />
            <AnimatedStat value="98%" label="Satisfaction" suffix="%" />
          </div>
          ...
          {/* Testimonial */}
          <div 
            className="p-6 rounded-xl bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 relative overflow-hidden group hover:border-emerald-500/30 transition-colors duration-300 animate-fade-in-up"
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 relative z-10">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-1 overflow-hidden rounded-t-xl">
            <div className="h-full bg-gradient-to-r from-emerald-500 via-blue-500 to-emerald-500 animate-[shimmer_3s_ease-in-out_infinite] bg-[length:200%_100%]" />
          </div>
          ...
          <CardContent className="pt-6 relative z-10">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="signin" className="space-y-5 mt-6 animate-fade-in-up">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-3 gap-3">
                    {socialButtons.slice(0, 3).map((btn) => (
                      <SocialButton
                        key={btn.provider}
              ...
              <TabsContent value="signup" className="space-y-5 mt-6 animate-fade-in-up">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {password && (
                      <div className="space-y-2 p-3 bg-white/5 rounded-lg border border-white/5 animate-fade-in-up">
