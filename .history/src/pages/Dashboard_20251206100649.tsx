...
const Dashboard = () => {
  ...
  const stats = useMemo(() => {
    ...
    // WIN RATE CALCULATION (Excluding Break Even)
    const validTradesCount = wins.length + losses.length;
    const winRate = validTradesCount > 0 ? (wins.length / validTradesCount) * 100 : 0;
