...
const Journal = () => {
  ...
  return (
    <div className="flex-1 w-full min-w-0 bg-[#0a0b0f] text-white relative font-sans selection:bg-emerald-500/30">
                      ...
                      <TableBody>
                        {filteredTrades.map((trade) => {
                          ...
                          const hasScreenshots =
                            trade.trade_images && trade.trade_images.length > 0;
      ...
      >
        <DialogContent className="w-[95vw] max-w-2xl bg-[#0F1018] border border-white/10 text-white max-h-[90vh] overflow-y-auto">
          <DialogHeader>
      ...
      >
        <AlertDialogContent className="bg-[#0F1018] border border-white/10 text-white">
          <AlertDialogHeader>
