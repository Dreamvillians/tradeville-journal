...
const QuickActions = memo(({ onNavigate }: { onNavigate: (path: string) => void }) => {
  ...
  return (
    <Card className="dash-glass dash-card-hover relative overflow-hidden h-full">
      {/* Fix: pointer-events-none added to prevent overlay blocking clicks */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-pink-500/5 pointer-events-none" />
      
      <CardHeader className="relative z-10 pb-2 pt-4 px-5">
      ...
      <CardContent className="relative z-10 p-5 pt-0 h-[calc(100%-60px)] flex items-center">
        <div className="grid grid-cols-2 gap-3 w-full">
          {actions.map((action, index) => (
            <Button
              ...
              className={cn(
                "h-auto py-3 flex flex-col items-center gap-1.5 group transition-all w-full",
                action.primary 
                  ? "bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-lg shadow-emerald-500/25 border-none" 
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-xs text-gray-500">Last 14 Days</CardDescription>
          </div>
    ...
    <div className="min-h-screen bg-[#0a0b0f] text-white font-sans selection:bg-emerald-500/30">
      ...
      <main className={cn(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 auto-rows-fr">
          ...
          {/* 2. Quick Actions (1 col on Desktop, 2 on Tablet to sit next to Welcome) */}
          <div className="md:col-span-2 lg:col-span-1 dash-slide-up" style={{ animationDelay: '50ms' }}>
            <QuickActions onNavigate={navigate} />
          </div>

          {/* 3. Primary Stat (Total PnL) */}
          ...
          {/* 8. Extra Stats (1 col) */}
          <div className="flex flex-col gap-4 dash-slide-up" style={{ animationDelay: '400ms' }}>
