...
// Mobile Trade Card (Kept for mobile responsiveness)
...
const Journal = () => {
  ...
  const [selectedTrade, setSelectedTrade] = useState<Trade | null>(null); // For View Column
                  ...
                  <Table>
                    <TableHeader className="bg-white/[0.02] border-b border-white/5 sticky top-0 z-10 backdrop-blur-sm">
                      <TableRow className="hover:bg-transparent border-none">
                        ...
                        <TableHead className="h-10 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Instrument</TableHead>
                        ...
                        <TableHead className="h-10 text-[10px] font-bold text-gray-500 uppercase tracking-wider text-center">View</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {filteredTrades.map((trade) => {
