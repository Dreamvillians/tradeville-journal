...
import { LogOut, CalendarDays, PanelLeft, X } from "lucide-react"; // Added PanelLeft and X
import {
  ReactNode,
  useEffect,
  useMemo,
...
// This component must be a child of SidebarProvider to access the context
        ...
        <div className="flex flex-1 flex-col h-full min-w-0 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3 flex-1 min-w-0">
              {/* REPLACED Standard SidebarTrigger with Custom Component */}
