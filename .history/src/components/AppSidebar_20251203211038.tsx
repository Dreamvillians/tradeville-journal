...
const MarketTicker = memo(() => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 overflow-hidden bg-black/60 backdrop-blur-xl border-b border-white/5">
  ...
  return (
    <SidebarProvider>
      ...
      <div className="flex min-h-screen w-full bg-[#05060b] text-foreground pt-10">
        {/* pt-10 accounts for the fixed ticker height (~40px) */}
        <AppSidebar />
        <div className="flex-1 flex flex-col">
          ...
          >
            {/* top-10 positions it below the ticker */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 rounded-full border border-border/80 bg-background/70 px-2 py-1">
                ...
                <Button
                  ...
                  className="gap-1 ml-1 text-xs text-muted-foreground hover:bg-red-500/10 hover:text-red-500 transition-colors"
                >
